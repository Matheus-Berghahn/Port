...
, <span style={{ color: '#1599d1' }}>CSS</span>, <span style={{ color: '#db9b26' }}>JS</span> (<span style={{ color: '#5ccfee' }}>React</span>, <span style={{ color: '#e6d04b' }}>JSON</span>) e <span style={{ color: '#7ab33e' }}>node.js</span>, além de outras sub-funcionalidades. Ao longo do último ano, tenho me dedicado à criação de sites e páginas, aprimorando minhas habilidades nessa área.<br></br><br></br>Meu objetivo profissional é continuar a aprimorar minhas habilidades e crescer na minha carreira. Procuro por uma empresa que possa me proporcionar suporte nesse sentido, para que eu possa desenvolver projetos de alta qualidade e contribuir com a equipe de forma efetiva. Estou aberto a oportunidades de trabalho e gostaria de discutir como minha experiência pode ser valiosa para sua empresa.</p>
        ...
        <div className='right'>
          <div className="shape_img">
            ...
            <button className={`btn2 ${isVisible ? "anima-btn" : "not-anima-btn"}`} onClick={scrollToClasseDeDestino3}>Animações</button>
          </div>
        </div>
      </div>
